    ...
    <div className="min-h-screen">
      <aside className="fixed inset-y-0 left-0 z-20 hidden w-72 border-r border-white/70 bg-white/82 p-6 shadow-xl shadow-slate-900/5 backdrop-blur-xl lg:block">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold tracking-[0.12em] text-teal-700">ระบบติดตามทรัพยากร</p>
            <h1 className="text-lg font-bold text-slate-950">ทีมสิ่งแวดล้อม รพ.บางคล้า</h1>
          </div>
        </div>
      ...
      <div className="lg:pl-72">
        <header className="sticky top-0 z-10 border-b border-white/70 bg-white/80 px-5 py-4 backdrop-blur-xl lg:hidden">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold tracking-[0.12em] text-teal-700">ทีมสิ่งแวดล้อม รพ.บางคล้า</p>
              <h1 className="font-bold text-slate-950">ระบบติดตามทรัพยากร</h1>
            </div>
